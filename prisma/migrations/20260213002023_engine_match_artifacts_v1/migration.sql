/*
  ...
  - You are about to drop the `BobuxLot` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropIndex
DROP INDEX "BobuxLot_sourceType_sourceId_idx";

-- DropIndex
DROP INDEX "BobuxLot_rewardClaimId_idx";

-- DropIndex
DROP INDEX "BobuxLot_userId_expiresAt_idx";
...
-- CreateTable
CREATE TABLE "EngineMatchArtifactV1" (
    ...
    "gameModeVersion" INTEGER NOT NULL,
    "engineCompatVersion" INTEGER NOT NULL,
    "pointerJson" JSONB NOT NULL,
    "snapshotsJson" JSONB NOT NULL,
    "matchResultJson" JSONB NOT NULL,
    "insightRecordJson" JSONB NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "EngineMatchArtifactV1_matchId_key" ON "EngineMatchArtifactV1"("matchId");
