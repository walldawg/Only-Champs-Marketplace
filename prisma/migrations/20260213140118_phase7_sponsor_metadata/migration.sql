...
CREATE TABLE "new_TournamentArtifactV1" (
    "sponsorId" TEXT,
    "id" TEXT NOT NULL PRIMARY KEY,
    "tournamentId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "matchIdsJson" JSONB NOT NULL,
    "standingsJson" JSONB NOT NULL,
    "rewardPolicyJson" JSONB,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "TournamentArtifactV1_sponsorId_fkey" FOREIGN KEY ("sponsorId") REFERENCES "Sponsor" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_TournamentArtifactV1" ("createdAt", "id", "matchIdsJson", "name", "rewardPolicyJson", "standingsJson", "tournamentId") SELECT "createdAt", "id", "matchIdsJson", "name", "rewardPolicyJson", "standingsJson", "tournamentId" FROM "TournamentArtifactV1";
DROP TABLE "TournamentArtifactV1";
ALTER TABLE "new_TournamentArtifactV1" RENAME TO "TournamentArtifactV1";
CREATE UNIQUE INDEX "TournamentArtifactV1_tournamentId_key" ON "TournamentArtifactV1"("tournamentId");
CREATE INDEX "TournamentArtifactV1_createdAt_idx" ON "TournamentArtifactV1"("createdAt");
