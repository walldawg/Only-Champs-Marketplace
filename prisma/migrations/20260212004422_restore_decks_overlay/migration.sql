...
CREATE TABLE "DeckCardVersion" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "DeckCardVersion_deckId_fkey" FOREIGN KEY ("deckId") REFERENCES "Deck" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "DeckCardVersion_versionKey_fkey" FOREIGN KEY ("versionKey") REFERENCES "CardVersion" ("versionKey") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_GamePlayer" ("createdAt", "deckId", "gameId", "id", "seat") SELECT "createdAt", "deckId", "gameId", "id", "seat" FROM "GamePlayer";
...
-- CreateIndex
CREATE INDEX "Deck_archivedAt_idx" ON "Deck"("archivedAt");

-- CreateIndex
CREATE INDEX "DeckCardVersion_versionKey_idx" ON "DeckCardVersion"("versionKey");

-- CreateIndex
CREATE UNIQUE INDEX "DeckCardVersion_deckId_versionKey_key" ON "DeckCardVersion"("deckId", "versionKey");
