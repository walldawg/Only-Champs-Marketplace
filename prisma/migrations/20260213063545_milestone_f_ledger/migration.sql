...
CREATE TABLE "BoBuckLedger" (
    ...
    CONSTRAINT "BoBuckLedger_parentEntryId_fkey" FOREIGN KEY ("parentEntryId") REFERENCES "BoBuckLedger" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "BoBuckLedger_userId_idx" ON "BoBuckLedger"("userId");

-- CreateIndex
CREATE INDEX "BoBuckLedger_contextId_idx" ON "BoBuckLedger"("contextId");

-- CreateIndex
CREATE INDEX "BoBuckLedger_parentEntryId_idx" ON "BoBuckLedger"("parentEntryId");
