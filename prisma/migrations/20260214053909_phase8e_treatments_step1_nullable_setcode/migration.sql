/*
  ...
  - You are about to drop the `ModeRuleBinding` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `RuleSet` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropIndex
DROP INDEX "ModeRuleBinding_modeKey_key";

-- DropIndex
DROP INDEX "RuleSet_key_version_key";

-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "ModeRuleBinding";
...
-- CreateIndex
CREATE UNIQUE INDEX "Treatment_setCode_key_key" ON "Treatment"("setCode", "key");
